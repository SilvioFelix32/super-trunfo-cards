/*
 * Super Trunfo de Países - Nível Intermediário
 *
 ...
 * PIB e pontos turísticos. Calcula também densidade populacional e PIB per capita.
 *
...
int main(void)
{
    ...
    /* Densidade = população / área; PIB per capita em reais = PIB (bi) × 10⁹ / população */
